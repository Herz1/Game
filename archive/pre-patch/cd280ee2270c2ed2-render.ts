...
namespace LT {
  ...
  export class Renderer {
    ctx:CanvasRenderingContext2D;ground:HTMLCanvasElement|null=null;world:World|null=null;camX=0;camY=0;zoom=1.35;time=0;effects:{event:BattleEvent;born:number}[]=[];shake=0;dir=0;moving=false;titleImage:HTMLImageElement|null=null;
    ...
    load(world:World,s:State):void {this.world=world;const p=this.iso(s.x,s.y);this.camX=p.x;this.camY=p.y;this.ground=this.makeGround(world);}
